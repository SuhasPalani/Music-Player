...
class Player(tk.Frame):
	...
	def track_widgets(self):
		...
		self.songtrack['text'] = 'Suhas Music player'
...
root.wm_title('Suhas')
img = PhotoImage(file='C:\programming\Music_Player\images\music.gif')
next_ = PhotoImage(file = 'C:\programming\Music_Player\images\\next.gif')
prev = PhotoImage(file='C:\programming\Music_Player\images\previous.gif')
play = PhotoImage(file='C:\programming\Music_Player\images\play.gif')
pause = PhotoImage(file='C:\programming\Music_Player\images\pause.gif')
